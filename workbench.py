...
class fenster:
	def __init__(self, typ, fenstername, fensterrect):
		...
		if self.typ == "workbench":
			self.icons.append(appicon("Ram Disk" ,"ramdisk", (40,30), "dir:/home/wolf", "images/fd1.png", "images/fd2.png"))
			self.icons.append(appicon("DH0" ,"hd", (20,100), "dir:/home/wolf/dh0", "images/hd1.png", "images/hd2.png"))
			self.icons.append(appicon("DH1" ,"hd", (20,170), "dir:/home/wolf/dh1", "images/hd1.png", "images/hd2.png"))
			self.icons.append(appicon("Shell" ,"cli", (30,240), "starte:Shell", "images/cli1.png", "images/cli2.png"))
...
#	def updateout(self):
#		self.outfensterrect = pygame.Rect(self.fensterrect)
	...
	def leftmouseclick(self, screen, mousepos, leftclickpos):
		...
		if self.aktiv:
			if pygame.Rect(self.fensterrect.x+self.fenstercloserect[0],self.fensterrect.y+self.fenstercloserect[1],self.fenstercloserect[2],self.fenstercloserect[3]).collidepoint(leftclickpos):
				...
				print(self.fensterrect)
				if self.fensterrect==self.savefensterrect:
					self.savefensterrect.x = self.fensterrect.x
					self.savefensterrect.y = self.fensterrect.y
					self.savefensterrect.w = self.fensterrect.w
					self.savefensterrect.h = self.fensterrect.h						
					self.fensterrect.x = 1
					self.fensterrect.y = 22
					self.fensterrect.w = screen.get_width()-2
					self.fensterrect.h = screen.get_height()-23
				else:
...
# Icons Workbench
	...
	wbicons = []
	wbicons.append(appicon("Ram Disk" ,"ramdisk", (40,30), "dir:/home/wolf", "images/fd1.png", "images/fd2.png"))
	wbicons.append(appicon("DH0" ,"hd", (20,100), "dir:/home/wolf/dh0", "images/hd1.png", "images/hd2.png"))
	wbicons.append(appicon("DH1" ,"hd", (20,170), "dir:/home/wolf/dh1", "images/hd1.png", "images/hd2.png"))
	wbicons.append(appicon("Shell" ,"cli", (30,240), "starte:Shell", "images/cli1.png", "images/cli2.png"))
			...
			for afenster in aktivfenster:				
				if leftclick:
					...
					if aktion == "close":
						...
						print(mousepos[0]-leftclickpos[0],mousepos[1]-leftclickpos[1])
						print(afenster.fensterrect)												
						print(afenster.outfensterrect)	
...
# Befehlsverarbeitung
		if befehl != "":
			...
			if befehl=="Workbench verlassen":
				aktivfenster.append(fenster("verlassen","Workbench",pygame.Rect(5,43,220,140)))
...
#				running=False
				...
				aktivfenster.append(fenster("hinweis","Version",pygame.Rect(10,50,200,170)))
				...
				if workbenchfenster==True:
					...
					aktivfenster.append(fenster("workbench","Workbench",pygame.Rect(1,22,width-2,height-44)))
					aktivfenster[0].icons.append(appicon("Ram Disk" ,"ramdisk", (40,30), "dir:/home/wolf", "images/fd1.png", "images/fd2.png"))
					aktivfenster[0].icons.append(appicon("DH0" ,"hd", (20,100), "dir:/home/wolf/dh0", "images/hd1.png", "images/hd2.png"))
					aktivfenster[0].icons.append(appicon("DH1" ,"hd", (20,170), "dir:/home/wolf/dh1", "images/hd1.png", "images/hd2.png"))
