...
def main():
	...
	aktivfenster[0].icons.append(appicon("Ram Disk" ,"ramdisk", (40,30), "dir:ramdisk", "images/fd1.png", "images/fd2.png"))
		...
		if len(aktivfenster)>0:
			...
			for afenster in reversed(aktivfenster):
				if isaktivclick:
					if leftclick:
						if leftdoppelclick:
							befehl = afenster.leftmousedoppelclick(screen, mousepos, leftclickpos)
							leftdoppelclick = False
